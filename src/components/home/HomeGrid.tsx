        ...
        <div className='py-8 lg:py-20'>
            ...
            <div className="overflow-hidden flex flex-col items-center">
                <div className="homegrid h-[90vh] gap-2 lg:gap-4 min-w-[150vh]">
                    <img loading="lazy" className='h-full w-full object-cover' src={img5} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img3} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img5} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img3} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img3} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img4} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img4} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img3} alt="img" />
                    <img loading="lazy" className='h-full w-full object-cover' src={img2} alt="img" />
                </div>
            </div>
