...
export default function CartModal() {
    const { isCartOpen, setIsCartOpen, isNavOpen, cartItems } = useData()
    ...
    return (
        <div className={`${!isCartOpen ? 'hidden' : 'block'} fixed inset-0 duration-300 z-30  bg-black bg-opacity-50`}>
